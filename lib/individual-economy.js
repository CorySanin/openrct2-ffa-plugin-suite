(function () {
    var PLAYER_PROFILES_KEY = 'playerProfiles';
    var RIDE_PROPERTIES_KEY = 'rideProperties';
    var INITIAL_DOLLARS_KEY = 'initialDollars';
    ...
    function getPlayer(playerID) {
        ...
        var p = network.getPlayer(playerID);
        if (p && !(p.publicKeyHash in playerProfiles)) {
            ...
            network.sendMessage("{NEWLINE}{YELLOW}This server uses ffa-individual-economy. You currently have a balance of {WHITE}".concat(initialDollars, "{YELLOW} to build with.{NEWLINE}To see your balance at any time, say `{WHITE}!cash{YELLOW}` in chat."), [playerID]);
        }
        else if (p) {
